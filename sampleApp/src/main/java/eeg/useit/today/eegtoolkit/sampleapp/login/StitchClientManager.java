package eeg.useit.today.eegtoolkit.sampleapp.login;

/**
 * Created by mirzakhalov on 3/24/18.
 */

/** StitchClientManager.java */
...
class StitchClientManager {
    ...
    private StitchClientManager(Context ctx) {
        StitchClientFactory.create(ctx, "testapplication-jxvbl").addOnSuccessListener(new OnSuccessListener<StitchClient>() {
            @Override
